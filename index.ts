...
console.log("--------------------------")
    ...
    // ** EXercise 7 & 8. Number Eight & create four lines : 
console.log(5+3);
console.log( 11-3);
console.log(4 *2);
console.log(16/ 2);
...
console.log("--------------------------")
    ...
    // * * Exercise 11 **
let member: string[] = [`azar`, `saqlain`, `mehmood`, `sana`, `seema`];
...
console.log("--------------------------")
    ...
    // ** Exercise 12 **
 let members: string[] = ["azar", "saqlain", "mehmood", "sana", "seema"];
 let messege: string = 'Today is a rainy day';
...
let guestList: string[] = ["Jiya", "Hamiz", "Sarah", "Sonia"];
...
let notPresent : string = "Sarah";
let newGuest : string = "Shrmeen";
...
let places : string [] =[ "Captown", "Dehli", "Iran", "China", "Bankok"];
...
// print a massage indicating the number of people you are inviting to dinner.
   ...
   // array
     let guestArray : string [] = ["Jiya", "Hamiz", "Sarah", "Sonia"];
...
let languages: string []= [ ' English', "French", 'Urdu', 'Hindi', ' Arabic'];
console.log("list of languages:")
for(let top of languages){
    console.log(top)
}

let mountains: string []= [ ' K_2', "Nanga Parbut", 'Mount Everest', 'Mount Albres'];
console.log("list of mountains:")
for(let top of mountains){
    console.log(top)
}

let rivers: string []= ['Indus River', "Nile River", 'Amazon River', 'Volga River'];
...
let cities: string []= [ 'Karachi', "Multan", 'Lahore', 'Melsi'];
...
// ERROR
let aray: (string | Number) []= [`babr`, `Taha`, 3,5,8];
console.log(aray[5]);

//  CORRECTION
let array: (string | Number) []= [`babr`, `Taha`, 3,5,8, 'Noian'];
console.log(array[5]);
console.log(array[4]);
console.log(array[0]);
console.log(array[3]);
...
//  If the alien is red, print a message that the player earned 15 points.
    ...
    let favoriteFruits : string [] = ["mango","peach","banana"]
...
let users : string [] = ["Sara","Beena","Jiya", "Sana", "admin"]
...
let currentUsers: string [] = ["Ali","Sana", " Nina", "Irsa", "admin"];
...
let magician: string[] = ["Merlin", "Harry Houdini", "David Copperfield", "Hans Klok"];
...
let magicians_42: string[] = ['Morgan the Marvelous', 'Victor Vaudeville', 'Phoenix the Phenomenon'];

function make_great_42(magicians: string[]) {
    for (let i = 0; i < magicians.length; i++) {
        magicians[i] = magicians[i] + ' The Great'; // Added space before 'The Great'
    }
}

function show_magicians_42(magicians: string[]) {
...
let magicians_43: string[] = ['Morgan the Marvelous', 'Victor Vaudeville', 'Phoenix the Phenomenon'];

function make_great_43(magicians: string[]): string[] {
...
function make_car(manufacturer: string, model: string, ...options: [string, any][]): object {
    let car: { [key: string]: any } = { manufacturer, model }; // Added type annotation for car
